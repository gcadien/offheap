...
public class MemMapForPQ<E> {
    ...
    public MemMapForPQ(int recordSize, int totalElements, Serializer keySerializer )
    {
...
*/
    protected static<E> MemMapForPQ<E> resize(MemMapForPQ<E> orig, int factor, List<Integer> list)
    {

        MemMapForPQ<E> resized = new MemMapForPQ<>(orig.recordSize,orig.totalElements*factor, orig.keySerializer);
